...
class __TwigTemplate_1388758f76a5895979d0378dbcea220333e6cc097660086cac5e9934a304ab88 extends Twig_Template
{
    ...
    public function block_prepend($context, array $blocks = array())
    {
        ...
        ";
            ...
            if ($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["grav"]) ? $context["grav"] : null), "twig", array(), "any", false, true), "twig", array(), "any", false, true), "filters", array(), "any", false, true), "tu", array(), "array", true, true)) {
                // line 7
                echo $this->env->getExtension('AdminTwigExtension')->tuFilter($this->getAttribute((isset($context["field"]) ? $context["field"] : null), "prepend", array()));
            } else {
                // line 9
                echo $this->env->getExtension('GravTwigExtension')->translate($this->getAttribute((isset($context["field"]) ? $context["field"] : null), "prepend", array()));
            }
            // line 11
            echo "    </div>
";
...
";
    ...
    public function block_append($context, array $blocks = array())
    {
        ...
        if ($this->getAttribute((isset($context["field"]) ? $context["field"] : null), "append", array())) {
            ...
            if ($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["grav"]) ? $context["grav"] : null), "twig", array(), "any", false, true), "twig", array(), "any", false, true), "filters", array(), "any", false, true), "tu", array(), "array", true, true)) {
                // line 24
                echo $this->env->getExtension('AdminTwigExtension')->tuFilter($this->getAttribute((isset($context["field"]) ? $context["field"] : null), "append", array()));
            } else {
                // line 26
                echo $this->env->getExtension('GravTwigExtension')->translate($this->getAttribute((isset($context["field"]) ? $context["field"] : null), "append", array()));
            }
            // line 28
            echo "        </div>
    ";
