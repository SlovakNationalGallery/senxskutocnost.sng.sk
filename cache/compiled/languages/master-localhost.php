...
return [
    ...
    'timestamp' => 1476708509,
    'checksum' => 'f0de6d57f81ca902f7e9d57e9b3a888f',
    'files' => [
        'system/languages' => [
            'ar' => [
...
',
        ...
        'cs' => [
            'PLUGIN_ADMIN' => [
                ...
                'RESET_NEW_PASSWORD' => 'Prosím, zadej nové heslo &hellip;',
...
',
        ...
        'de' => [
            'PLUGIN_ADMIN' => [
                ...
                'ADDITIONAL_DEPENDENCIES_CAN_BE_REMOVED' => 'Das %s benötigt die folgenden Abhängigkeiten, die nicht von anderen installierten Pakete benötigt werden. Wenn Sie diese nicht verwenden, können Sie direkt hier direkt entfernt werden.',
...
```',
        ...
        'es' => [
            'PLUGIN_ADMIN' => [
                ...
                'MODAL_DELETE_PAGE_CONFIRMATION_REQUIRED_DESC' => '¿Seguro que deseas borrar esta página y todos sus hijos? Si la página está traducida en otros idiomas, se conservarán esas traducciones y deben ser borradas separadamente. De otra manera, la carpeta de la página será borrada con todas sus sub páginas. Esta acción no puede ser revertida.',
                'AND' => 'y',
                ...
                'CONFIRM_REMOVAL' => '¿Seguro que deseas borrar este %s?',
...
',
        ...
        'it' => [
            'PLUGIN_ADMIN' => [
                ...
                'RESET_NEW_PASSWORD' => 'Si prega di inserire una nuova password &hellip;',
                ...
                'JAVASCRIPT_PIPELINE_INCLUDE_EXTERNALS' => 'Includere file esterni nella pipeline di JS',
                ...
                'JAVASCRIPT_PIPELINE_BEFORE_EXCLUDES' => 'Inserisci prima la pipeline di JS',
                ...
                'PACKAGES_SUGGESTED_UPDATE' => 'Pacchetti già installati, ma che verranno aggiornati per avere l\'ultima versione disponibile',
...
',
        ...
        'ro' => [
            'PLUGIN_ADMIN' => [
                ...
                'EXCEEDED_FILESIZE_LIMIT' => 'Depăşire limită de dimensiune',
                'UNKNOWN_ERRORS' => 'Eroare necunoscută',
                'EXCEEDED_GRAV_FILESIZSE_LIMIT' => 'Depăşire limită de dimensiune a Grav.',
...
',
        ...
        'ru' => [
            'PLUGIN_ADMIN' => [
                ...
                'PAGE_SUMMARY' => 'Резюме страницы',
                'ENABLED' => 'Включено',
                'ENABLED_HELP' => 'Включить резюме страницы (резюме возвращает то же самое, что и содержание страницы)',
                'YES' => 'Да',
                'NO' => 'Нет',
                ...
                'HOME_PAGE_HELP' => 'Страница, которую Grav будет использовать в качестве главной страницы по умолчанию',
                ...
                'DEFAULT_DATE_FORMAT_PLACEHOLDER' => 'Угадать автоматически',
                ...
                'ADDITIONAL_DEPENDENCIES_CAN_BE_REMOVED' => '%s требует следующие зависимости, которые не требуются в других установленных пакетах. Если вы не используете их, вы можете удалить их прямо отсюда.',
...
',
        ...
        'th' => [
            'PLUGIN_ADMIN' => [
                ...
                'RESET_NEW_PASSWORD' => 'กรุณาใส่รหัสผ่านใหม่ &hellip;',
